                          ...
                          <tr>
                            <td colspan="2" style="width:100%;">
                              ...
                              <table 2cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                                <tr>
                                 <td style="width:30%; text-align:right;"><img src="<?=$url;?>img/firma-nv-1.jpg" width="115"/></td>
                                 <td style="width:40%;"></td>
                                 <td style="width:30%; text-align:left;"><img src="<?=$url;?>img/firma-nv-2.jpg" width="115"/></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
...
<?php          
    ...
    while($ct<=1){	
		...
		?>        
				...
				<div style="width: 775px; border: 0px solid #FFFF00;">
					<span style="font-weight:bold; font-size:75%;">
					Estimado Cliente, agradeceremos completar la información que se requiere a continuación: (utilice letra clara)
					<br>
