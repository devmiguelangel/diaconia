...
$selectUs.="order by
  ...
  if($res = $conexion->query($selectUs,MYSQLI_STORE_RESULT)){	  
				...
				<div class="da-form-row">
					...
					<div class="da-form-item small">';
						$selectTi="select 
									...
									where
										codigo!='ROOT';";
						if($rstip = $conexion->query($selectTi,MYSQLI_STORE_RESULT)){
				...
				<div class="da-form-row" id="content-departamento">
					...
					<div class="da-form-item small">';
						$selectDep="select
									...
									where
									  tipo_dp=1;";
						if($rsdep = $conexion->query($selectDep,MYSQLI_STORE_RESULT)){
							...
							echo'<select name="departamento" id="departamento" class="requerid" disabled>';
								  ...
								  $rsdep->free();
							echo'</select>
								 <span class="errorMessage" id="errordepartamento"></span>';
						}else{
							echo'<div class="da-message error">error en la consulta'.$conexion->errno.'&nbsp;'.$conexion->error.'</div>';
						}
			    echo'</div>
								...
								<div class="da-form-item small">';
								    ...
								    if($rstip = $conexion->query($selectTi,MYSQLI_STORE_RESULT)){
										echo'<select name="txtTipousuario" id="txtTipousuario" class="requerid">';
											  ...
											  $rstip->free();
										echo'</select>
											 <span class="errorMessage" id="errortipousuario"></span>';
									}else{
										echo'<div class="da-message error">error en la consulta'.$conexion->errno.'&nbsp;'.$conexion->error.'</div>';
									}
						   echo'</div>
