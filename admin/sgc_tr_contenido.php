						  ...
						  <div class="da-panel collapsible">
							  <div class="da-panel-header">
								  <span class="da-panel-title">
									  ...
									  <b>'.$regief['nombre'].'</b> - <span lang="es">Contenido Todo Riesgo Domiciliario</span>
								  </span>
							  </div>
												  ...
												  echo'<tr>
													 ...
													 echo'</td>
														  ...
														  <td class="da-icon-column">
															 <ul class="action_user">
																<li style="margin-right:5px;"><a href="?l=tr_contenido&editar=v&var='.$_GET['var'].'&idhome='.base64_encode($regi['id_home']).'&id_ef='.base64_encode($regief['id_ef']).'" class="edit da-tooltip-s" title="<span lang=\'es\'>Editar</span>"></a></li>';
														echo'</ul>	
														  </td>
													  </tr>';
											  }
		  ...
		  <div class="da-panel">
			  <div class="da-panel-header">
				  <span class="da-panel-title">
					  ...
					  <span lang="es">Actualizar Contenido Todo Riesgo Domiciliario</span>
				  </span>
			  </div>
			  <div class="da-panel-content">
				  <form class="da-form" action="" method="POST" enctype="multipart/form-data" name="formUpdateImage" id="formUpdateImage">
					  ...
					  <div class="da-form-row" style="text-align:center;">';
						  if(!empty($regImg['imagen'])){	  
							 ...
							 echo'<span lang="es">No existe el nombre en la base de datos</span>'; 
						  }
				 echo'</div>
					  <div class="da-form-row">
