					...
					<div class="da-panel collapsible">
						<div class="da-panel-header">
							<span class="da-panel-title" style="font-size:11.5px">
								...
								<b>'.$regief['nombre'].'</b> - <span lang="es">Administrar parámetros del Producto Todo Riesgo Domiciliario</span>
							</span>
						</div>
								  ...
								  if($num>0){
										while($regi = $res->fetch_array(MYSQLI_ASSOC)){
											echo'<tr style="font-size:11.5px;">
											   ...
											   echo'<td>
													   <ul class="action_user">
														  <li style="margin-right:5px;"><a href="?l=tr_montos&idhome='.base64_encode($regi['id_home']).'&id_ef='.base64_encode($regief['id_ef']).'&editar=v&var='.$_GET['var'].'" class="edit da-tooltip-s" title="<span lang=\'es\'>Editar</span>"></a></li>';
	  ...
	  $('#frmDatosAdmin').submit(function(e){
		  ...
		  $(this).find('.required').each(function(){
			  ...
			  if(monto_emite_usd!=''){
				 ...
				 sum++;
				 $('#errorarmaxemiusd').show('slow'); 
				 $('#errorarmaxemiusd').html('ingrese monto maximo emision usd'); 
			  }
					...
					//if(isset($_POST['txtMontFacu'])) $txtMontFacu = $_POST['txtMontFacu']; else $txtMontFacu = $fila['monto_facultativo'];
					  ...
					  echo'<div class="da-panel" style="width:600px;">
							<div class="da-panel-header">
								<span class="da-panel-title">
									<img src="images/icons/black/16/pencil.png" alt="" />
									<span lang="es">Editar datos Todo Riesgo Domiciliario</span> 
								</span>
							</div>
							<div class="da-panel-content">
								<form class="da-form" name="frmDatosAdmin" action="" method="post" id="frmDatosAdmin">
									...
									<div class="da-form-row">
										<label style="width:190px; text-align:right; margin-right:10px;"><b><span lang="es">Facturación</span></b></label>
										<div class="da-form-item">
											<ul class="da-form-list inline">';
											   if($factura==1){	
