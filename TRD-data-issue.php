...
?>
            	<select id="dp-<?=$k;?>-depto" name="dp-<?=$k;?>-depto" class="required fbin <?=$read_new;?>" <?=$read_save;?>>
            		<option value="">Seleccione...</option>
<?php
...
?>
            ...
            <td>
            	<textarea id="dp-<?=$k;?>-zone" name="dp-<?=$k;?>-zone" class="required fbin" <?=$read_new.' '.$read_save;?>><?=$rowPr['pr_zona'];?></textarea>
            </td>
            <td>
            	<input type="text" id="dp-<?=$k;?>-locality" name="dp-<?=$k;?>-locality" autocomplete="off" value="<?=$rowPr['pr_localidad'];?>" class="required text-2 fbin " <?=$read_new.' '.$read_save;?>>
            </td>
            <td colspan="2">
            	<textarea id="dp-<?=$k;?>-address" name="dp-<?=$k;?>-address" class="required fbin" <?=$read_new.' '.$read_save;?>><?=$rowPr['pr_direccion'];?></textarea>
            </td>
        </tr>
        <tr class="title-vh" valign="top">
			<td >Tipo</td>
        ...
        <tr valign="top" class="thead">
        	<td>
        		<select id="dp-<?=$k;?>-type" name="dp-<?=$k;?>-type" class="required fbin <?=$read_new;?>" <?=$read_save;?>>
	            	<option value="">Seleccione...</option>
<?php
...
?>
        	...
        	<td>
            	<select id="dp-<?=$k;?>-use" name="dp-<?=$k;?>-use" class="required fbin <?=$read_new;?> dp-use" <?=$read_save;?> data-rel="<?=$k;?>">
            		<option value="">Seleccione...</option>
<?php
...
?>
				...
				<input type="text" id="dp-<?=$k;?>-use-other" name="dp-<?=$k;?>-use-other" autocomplete="off" value="<?=$rowPr['pr_uso_otro'];?>" class="<?=$required_use;?> text-2 fbin " <?=$read_new.' '.$read_save;?> style="margin-top: 2px; <?=$display_use;?>">
            </td>
            <td>
            	<select id="dp-<?=$k;?>-state" name="dp-<?=$k;?>-state" class="required fbin <?=$read_new;?>" <?=$read_save;?>>
            		<option value="">Seleccione...</option>
<?php
